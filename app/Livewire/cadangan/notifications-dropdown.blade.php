<div>
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationsDropdown" style="max-height: 250px; overflow-y: auto;">
            @forelse($notifications as $notif)
                <li>
                    <a href="#" wire:click.prevent="markAsRead({{ $notif->id }})" class="dropdown-item">
                        <strong>Admin</strong> menghapus komentar Anda karena: <em>{{ $notif->alasan }}</em>
    ...
    @if($showModal) show d-block @endif" tabindex="-1" style="@if($showModal) display: block; @else display: none; @endif" role="dialog">
